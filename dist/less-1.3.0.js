...
tree.functions = {
    ...
    randomColor:function(colorDummy){
        var color=this.rgb(Math.round(Math.random()*255),Math.round(Math.random()*255),Math.round(Math.random()*255));
//        console.log(color.toHSL());
        return hsla(color.toHSL());
    },
    flip:function(color){
        var hsl = color.toHSL();
//        hsl.s = 1-hsl.s;
    ...
    triadLeft: function(color){
        return this.spin(color,120);
    },
    triadRight: function(color){
        return this.spin(color,-120);
    },
    adjacentRight: function(color){
        return this.spin(color,-30);
    },
    adjacentLeft: function(color){
        return this.spin(color,+30);
    },
    complementary:function(color){
        return this.spin(color,180);
    },
...
//            if(name){console.log(name);console.log(variable);}
            return variable }
        else {
            throw { type: 'Name',
